...
const Details = () => {
    ...
    return (
        <div style={{ backgroundImage: `url('${background}')` }} className="p-20 ">
            ...
            <div className='grid gap-20 grid-cols-1 md:grid-cols-2 p-10 justify-center items-center bg-blue-700 rounded'>
                ...
                <div className='grid grid-cols-1 md:grid-cols-2'>
                    ...
                    <div className='grid grid-cols-1'>
                        <button className='btn btn-primary text-white mb-5'>Live site</button>
                        <button className='btn btn-primary text-white mb-5'>Github client</button>
